    ...
    if ((Pr_1 >= 0 && Pr_2 <= 0) || (Pr_1 <= 0 && Pr_2 >= 0)) {
        ...
        if (tipo === "CONEXION_EN_K" || tipo === "CONEXION_EN_N") {
            ...
            if (limites.rama.apply(this, [miembro_b1, miembro]) !== undefined && limites.rama.apply(this, [miembro_b2, miembro]) !== undefined && limites.cordon.apply(this, [miembro]) !== undefined) {
                ...
                if ((Pr_1 === 0 && Pr_2 === 0) || ((abs((Pr_1 * sin(thetaRad_1)) / (Pr_2 * sin(thetaRad_2))) >= 0.8) && (abs((Pr_1 * sin(thetaRad_1)) / (Pr_2 * sin(thetaRad_2))) <= 1.2))) {
                    e = 0;
   ...
   */
    ...
    le_3: function (miembro_bi, miembro_bj, miembro, beoi, beov, Ov) {
        ...
        if (Ov >= 25 && Ov < 50) {
            ...
            le = ((2 * Ov) / 50) * ((1 - (Ov / 100)) * (Hb_i / sin(thetaRad_i)) + (Ov / 100) * (Hb_i / (sin(thetaRad_i + thetaRad_j)))) + b_eoi + b_eov;
